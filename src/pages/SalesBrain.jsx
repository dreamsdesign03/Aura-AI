                  ...
                  {subTab === "chat" && (<div className="flex flex-col h-full" style={{ height: "100%" }}>
                      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
                        {chatHistory.length === 0 && (<div className="text-center py-8">
                            ...
                            <p className="text-sm font-semibold text-gray-700 mb-1">Your personal assistant is ready</p>
                            <p className="text-xs text-gray-400 mb-4 max-w-xs mx-auto">I'm your Aura-AI assistant. I know you, and I also know {sel.firstName}. Ask me anything — help running your business, drafting messages, or closing this deal.</p>
                            <div className="flex flex-wrap justify-center gap-2">
                              {[
                            `What's blocking this deal?`,
                            `Draft a follow-up WhatsApp for ${sel.firstName}`,
                            `Summarize where I stand with ${sel.firstName}`,
                            `Help me plan my day`,
                    ...
                    e.preventDefault();
                    sendChat();
                } }} placeholder={`Ask your assistant anything, or about ${sel.firstName}…`} rows={2} className="flex-1 text-sm resize-none border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-400/40"/>
