...
const BASE = "/api";
const SOURCE_META = {
    manual: { label: "Manual", color: "#A4285E", bg: "#E6F4EC", Icon: UserPlus },
    ...
    return (<div className="p-6 space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-3">
        {[
            ...
            { label: "Fresh (not fetched)", value: statsData?.fresh ?? 0, icon: <Zap className="w-4 h-4 text-white"/>, bg: "#A4285E" },
            { label: "Imported to Leads", value: statsData?.imported ?? 0, icon: <CheckCircle2 className="w-4 h-4 text-white"/>, bg: "#CB3273" },
