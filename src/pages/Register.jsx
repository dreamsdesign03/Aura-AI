...
export default function Register({ onSuccess, onLoginClick }) {
    ...
    return (<div className="min-h-screen flex flex-col lg:flex-row relative overflow-hidden" style={{ fontFamily: "'Inter', -apple-system, sans-serif", background: "linear-gradient(150deg, #1A050F 0%, #3A0C20 35%, #8E1F54 70%, #CB3273 100%)" }}>
      ...
      <div className="lg:hidden absolute inset-0 pointer-events-none">
        ...
        <div style={{
            position: "absolute", inset: 0,
            background: "radial-gradient(ellipse 380px 300px at 15% 20%, rgba(229,139,181,0.22) 0%, transparent 70%), radial-gradient(ellipse 280px 220px at 85% 75%, rgba(203,50,115,0.28) 0%, transparent 70%)",
        }}/>
        {/* Floating orbs */}
        <div style={{
            position: "absolute", top: "8%", right: "10%",
            width: 120, height: 120, borderRadius: "50%",
            background: "radial-gradient(circle, rgba(229,139,181,0.15) 0%, transparent 70%)",
            filter: "blur(20px)",
        }}/>
        <div style={{
            position: "absolute", bottom: "20%", left: "5%",
            width: 160, height: 160, borderRadius: "50%",
            background: "radial-gradient(circle, rgba(203,50,115,0.18) 0%, transparent 70%)",
            filter: "blur(24px)",
        }}/>
      </div>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[460px] flex-shrink-0 px-12 py-12 relative overflow-hidden" style={{ background: "linear-gradient(150deg, #1A050F 0%, #3A0C20 35%, #8E1F54 70%, #CB3273 100%)" }}>
        ...
        <div className="relative z-10">
          <div style={{ display: "inline-flex", alignItems: "center", fontSize: 11, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", color: "#E58BB5", background: "rgba(229,139,181,0.12)", border: "1px solid rgba(229,139,181,0.2)", padding: "5px 14px", borderRadius: 100, marginBottom: 24 }}>AI Sales Automation</div>
          <h2 style={{ fontSize: "clamp(26px,2.2vw,34px)", fontWeight: 800, color: "white", lineHeight: 1.18, letterSpacing: "-0.025em", marginBottom: 16 }}>
            ...
            <span style={{ color: "#F3C9DB", textShadow: "0 0 40px rgba(229,139,181,0.4)" }}>faster revenue growth.</span>
          </h2>
          ...
          <div className="space-y-3">
            {["AI-powered lead scoring & qualification", "Automated outreach via email & WhatsApp", "Real-time pipeline & deal tracking", "HubSpot, Google Calendar integrations"].map(f => (<div key={f} className="flex items-center gap-3">
                <div style={{ width: 16, height: 16, borderRadius: "50%", background: "rgba(229,139,181,0.2)", border: "1px solid rgba(229,139,181,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#E58BB5" }}/>
                </div>
      ...
      <div className="flex-1 flex flex-col lg:bg-[#FBE9F1] relative z-10">
        ...
        {step === "idle" && (<div className="lg:hidden flex flex-col items-center text-center px-6 pt-16 pb-8">
            ...
            {/* Brand */}
            <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase", color: "rgba(229,139,181,0.7)", marginBottom: 6 }}>AuraAI</div>

            {/* Badge */}
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 10, fontWeight: 700, letterSpacing: "1.5px", textTransform: "uppercase", color: "#E58BB5", background: "rgba(229,139,181,0.1)", border: "1px solid rgba(229,139,181,0.2)", padding: "4px 12px", borderRadius: 100, marginBottom: 20 }}>
              AI Sales Automation
            </div>
            ...
            <h1 style={{ fontSize: 32, fontWeight: 900, color: "white", lineHeight: 1.12, letterSpacing: "-0.035em", marginBottom: 12 }}>
              ...
              <span style={{ color: "#F3C9DB", textShadow: "0 0 30px rgba(229,139,181,0.35)" }}>starts here.</span>
            </h1>
        ...
        <div className="space-y-3">
            ...
            }} className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl transition-all" style={{ fontSize: 15, fontWeight: 700, color: "white", border: "none", background: "linear-gradient(135deg, #A4285E, #CB3273)", cursor: "pointer", boxShadow: "0 4px 18px rgba(203,50,115,0.38)" }} onMouseEnter={e => (e.currentTarget.style.boxShadow = "0 6px 22px rgba(203,50,115,0.5)")} onMouseLeave={e => (e.currentTarget.style.boxShadow = "0 4px 18px rgba(203,50,115,0.38)")}>
                ...
                {/* Sign up with Google */}
                <button type="button" onClick={() => window.location.href = "/api/auth/google"} className="w-full flex items-center justify-center gap-3 py-3 rounded-2xl transition-all" style={{ fontSize: 14, fontWeight: 600, color: "#374151", border: "1.5px solid #E9E7F3", background: "white", cursor: "pointer" }} onMouseEnter={e => { e.currentTarget.style.borderColor = "#F3C9DB"; e.currentTarget.style.boxShadow = "0 2px 8px rgba(203,50,115,0.08)"; }} onMouseLeave={e => { e.currentTarget.style.borderColor = "#E9E7F3"; e.currentTarget.style.boxShadow = "none"; }}>
            ...
            {!profEmailSent ? (<>
                ...
                <form onSubmit={handleProfileSave} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                    <div>
                      <label style={{ display: "block", fontSize: 11, fontWeight: 600, marginBottom: 5, color: "#374151" }}>First name <span style={{ color: "#CB3273" }}>*</span></label>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                    <div>
                      ...
                      <input type="email" value={profEmail} onChange={e => setProfEmail(e.target.value)} placeholder="you@company.com" className={inputSm} style={{ border: "1.5px solid #FBE9F1" }}/>
                    </div>
                    <div>
                      <label style={{ display: "block", fontSize: 11, fontWeight: 600, marginBottom: 5, color: "#374151" }}>Phone no</label>
                      <input type="text" value={verifiedPhone} readOnly className={inputSm} style={{ border: "1.5px solid #FBE9F1", background: "#F9F8FF", color: "#6B7280", cursor: "default" }}/>
                    </div>
                  </div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                    <div>
                    ...
                    <div>
                      ...
                      <input type="text" value={profCompany} onChange={e => setProfCompany(e.target.value)} placeholder="Acme Inc." className={inputSm} style={{ border: "1.5px solid #FBE9F1" }}/>
                    </div>
                  </div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                    <div>
                      <label style={{ display: "block", fontSize: 11, fontWeight: 600, marginBottom: 5, color: "#374151" }}>Designation</label>
                      <input type="text" value={profDesignation} onChange={e => setProfDesignation(e.target.value)} placeholder="Sales Manager" className={inputSm} style={{ border: "1.5px solid #FBE9F1" }}/>
                    </div>
                    <div>
                ...
                <p style={{ fontSize: 13, color: "#6B7280", lineHeight: 1.6, marginBottom: 20 }}>
                  We sent a verification link to <strong style={{ color: "#A4285E" }}>{profEmail}</strong>.<br />
                  Click it to confirm your email and access your account.
                </p>
                <button type="button" onClick={onSuccess} className="w-full py-3 rounded-xl transition-all" style={{ fontSize: 14, fontWeight: 700, color: "white", border: "none", background: "linear-gradient(135deg, #A4285E, #CB3273)", cursor: "pointer", boxShadow: "0 4px 14px rgba(203,50,115,0.3)" }}>
                  Go to dashboard
                </button>
              </div>)}
          </div>
